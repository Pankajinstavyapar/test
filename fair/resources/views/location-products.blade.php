                    ...
                    <div class=" swiper-slide mb-4">
                        <div class="product-box">
                            ...
                            <div class="product-content">
                                <p class="pd-name mb-2"><a href="{{ url('/', ['pg_url' => $locationdata->pg_url, 'product_url' => $data->product_url]) }}">{{ $data->product_title }}</a></p>
                                <p class="text-clamp1">{{ $data->sort_description }}</p>
                                <a href="{{ url('/', ['pg_url' => $locationdata->pg_url, 'product_url' => $data->product_url]) }}" class="thm-btn  py-1">View Details</a>
                            </div>
                        </div>
                    </div>
                   @endforeach
