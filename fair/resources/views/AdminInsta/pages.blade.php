            ...
            <div class="row align-items-center">
              <div class="col-md-12">
                <ul class="breadcrumb">
                  ...
                  <li class="breadcrumb-item" aria-current="page">Pgaes</li>
                </ul>
              </div>
              <div class="col-md-12">
                <div class="page-header-title">
                  <h2 class="mb-0">Pgaes</h2>
                </div>
              </div>
          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate method="post" action="{{ route('AdminInsta.page.store') }}" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom01">Page Title</label>
                      <input type="text" class="form-control" id="validationCustom01" name="pg_name"/>
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom02">Page url</label>
                      <input type="text" class="form-control" id="validationCustom02" name="pg_url"/>
                    </div>
                    
                  
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom03">Meta Title</label>
                      <input type="text" class="form-control" id="validationCustom03" name="meta_title"/>
                    </div>
                    <div class="col-md-6 mb-3">
                        <label class="form-label" for="validationCustom03">Meta Keywords</label>
                        <input type="text" class="form-control" id="validationCustom03" name="meta_keyword"/>
                        
                      </div>
                      <div class="col-md-6 mb-3">
                        <label class="form-label" for="validationCustom03">Meta Description</label>
                        <input type="text" class="form-control" id="validationCustom03" name="meta_description"/>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" name="shrt_description">
