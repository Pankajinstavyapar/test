          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate method="post" action="{{ route('AdminInsta.category.update',$category->product_cat_id) }}" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom01">Category Title</label>
                      <input type="text" class="form-control" value="{{ $category->product_category_title }}" id="product_category_title" name="product_category_title"/>
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom02">Page Url</label>
                      <input type="text" class="form-control" value="{{ $category->pg_url }}" id="pg_url" name="pg_url"/>
                    </div>
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" value="{{ $category->short_description }}" name="short_description">
                    ...
                    <textarea name="description" value="{{ $category->description }}" id="ckeditor">
