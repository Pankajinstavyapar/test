          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate method="post" action="{{ route('AdminInsta.product.store') }}" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    @php
                   ...
                   @endphp
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" id="validationCustom03" name="pg_meta_title"  />
                    </div>

                    <div class="col-md-6 mb-3">
                        <label class="form-label" for="validationCustom03">Meta Keywords</label>
                        <input type="text" class="form-control" id="validationCustom03" name="pg_meta_keyword"/>
                      
                      </div>
                      <div class="col-md-6 mb-3">
                        <label class="form-label" for="validationCustom03">Meta Description</label>
                        <input type="text" class="form-control" id="validationCustom03" name="pg_meta_desc"  />
                    ...
                    <div class="col-md-12 mb-3">
                        ...
                        <textarea class="form-control" name="sort_description">
