          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate method="post" action="{{ route('AdminInsta.subdomain.store') }}" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" id="subdomain_slug" name="subdomain_slug"/>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="file" class="form-control" id="subdomain_image" name="subdomain_image" />
                    </div>
