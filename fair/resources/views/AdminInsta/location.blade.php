          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate method="post" action="{{ route('AdminInsta.location.store') }}" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    <div class="col-md-12">
                      <label class="form-label" for="location_image">Location Name</label>
                      <input type="text" class="form-control" id="loaction_name" name="loaction_name"  required />
                    </div>
                    {{-- <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom02">Page url</label>
                      <input type="text" class="form-control" id="pg_url" name="pg_url"  required />
                    </div> --}}
                      </div>
