          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate method="post" action="{{ route('AdminInsta.category.store') }}" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom01">Category Title</label>
                      <input type="text" class="form-control" id="product_category_title" name="product_category_title"/>
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom02">Page Url</label>
                      <input type="text" class="form-control" id="pg_url" name="pg_url"/>
                    </div>
