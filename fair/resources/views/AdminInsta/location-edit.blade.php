          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate method="post" action="{{ route('AdminInsta.location.update',$location->loaction_id) }}" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="location_image">Location Name</label>
                      <input type="text" class="form-control" value="{{ $location->loaction_name }}" id="loaction_name" name="loaction_name"  required />
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom02">Page url</label>
                      <input type="text" class="form-control" value="{{ $location->pg_url }}" id="pg_url" name="pg_url"  required />
                    </div>
                      </div>
                    
                    <div class="col-md-12 mb-3">
                        <label class="form-label" for="validationCustom03">Short Description</label>
                        <textarea class="form-control" value="{{ $location->short_description }}" name="short_description">
                    ...
                    <textarea name="description" value="{{ $location->description }}" id="ckeditor">
