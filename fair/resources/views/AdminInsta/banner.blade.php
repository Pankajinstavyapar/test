          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate method="post" action="{{ route('AdminInsta.banners.store') }}" enctype="multipart/form-data">
                    @csrf
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom01">Banner Title</label>
                      <input type="text" class="form-control" id="validationCustom01" name="banner_title" placeholder="Banner Title"  />
                      <div class="valid-feedback"> Looks good! </div>
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom02">Banner Second Title</label>
                      <input type="text" class="form-control" id="validationCustom02" name="banner_second_title" placeholder="Banner Second Title"   />
                      <div class="valid-feedback"> Looks good! </div>
                    </div>
                    ...
                    <div class="col-md-6 mb-3">
                      ...
                      <input type="text" class="form-control" id="validationCustom03" name="banner_position" placeholder="Banner Third Title"  />
                    ...
                    <div class="row">
                    <div class="col-md-12">
                    <textarea name="banner_discription" id="ckeditor">
