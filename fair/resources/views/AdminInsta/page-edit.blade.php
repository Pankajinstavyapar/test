          ...
          <div class="col-md-12">
            <div class="card">
              ...
              <div class="card-body">
                  ...
                  <form class="needs-validation" novalidate method="POST" action="{{ route('AdminInsta.pages.update',$pages->pg_id) }}" enctype="multipart/form-data">
                    @csrf 
                  
                  <div class="row">
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom01">Page Title</label>
                      <input type="text" class="form-control" id="validationCustom01" value="{{ $pages->pg_name }}" name="pg_name" placeholder="pages Title" />
                      
                    </div>
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom02">Page url</label>
                      <input type="text" class="form-control" id="validationCustom02" value="{{ $pages->pg_url }}" name="pg_url" placeholder="pages Second Title" />
                    
                    </div>
                    
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom03">Meta Title</label>
                      <input type="text" class="form-control" id="validationCustom03" value="{{ $pages->pg_meta_title }}" name="pg_meta_title" placeholder="pages Third Title" />
                    ...
                    <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom03" name="meta_keyword" value="{{ $pages->pg_meta_keyword }}" placeholder="pages Third Title"  />
                      ...
                      <div class="col-md-6 mb-3">
                        ...
                        <input type="text" class="form-control" id="validationCustom03" name="meta_description" value="{{ $pages->pg_meta_desc }}" placeholder="pages Third Title"  />
                    ...
                    <div class="col-md-6 mb-3">
                      <label class="form-label" for="validationCustom03">Second Image</label>
                      <input type="file" class="form-control" id="validationCustom03" name="image2"/>
                    ...
                    <div class="row">
                        <div class="col-md-12 mb-3">
                            ...
                            <textarea class="form-control" value="{{ $pages->short_description }}" name="shrt_description">
                              {{ $pages->short_description }}
                                </textarea>
                             </div>
                        <div class="row">
                        <div class="col-md-12">
                            <label class="form-label" value="{{ $pages->description }}" for="validationCustom03">Description</label>
